  ...
  static getStyles() {
    return `
      ...
      .result {
        ...
        border: 1px solid rgba(203, 213, 225, 0.25); border-radius: var(--radius); background: #fafafa;
        overflow: auto; box-sizing: border-box; box-shadow: var(--shadow-sm); text-align: center;
      }
